$(document).ready(function() {
    ...
    // BOX HIDE
    $('span.hide, span.unhide').click(function() {
        boxHide($(this));
    });
    ...
    $(".tooltip").tipsy({live: true, gravity: $.fn.tipsy.autoWE});
    ...
    $(".pager select").addClass("entries"); /* celula */
    ...
    $('.checkall').click(function() {
        $(this).parents('table').find('tr').find(':checkbox :first').attr('checked', this.checked); /*celula*/
    });

    // BUTTON LINKS
    $("button.small, button.medium, button.big").wrapInner("<span></span>");
    ...
    // FORMS
    $(".line:visible:odd").css({ /* CELULA - correcao para apenas visible */
        "border-top": "2px solid #f2f4f7",
        "border-bottom": "2px solid #f2f4f7"
    });
    $(".line:visible:first-child").css({ /* CELULA - correcao para apenas visible */
        "border-top": "none"
    });
    $(".line:visible:last-child").css({ /* CELULA - correcao para apenas visible */
        "border-bottom": "none"
    });
    ...
    */
    ...
    $("input[type=radio], input[type=checkbox]").each(function() {
        if ( ($(this).parents("table").length === 0)
            && ($(this).parents("div.ui-multiselect-menu").length === 0) ) {
            $(this).customInput();
        }
    });
    ...
    $('.hide-input input, .filter-box, .search input, .box-search input').focus(function() {
        if (this.value === this.defaultValue) {
            this.value = '';
        }
    });
