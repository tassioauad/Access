$(document).ready(function() {
    ...
    $('#popup_itemcount').change(function() { oTable.fnLengthChange( $(this).val() ); });
    ...
    $('.hide-input input, .search input, .box-search input').click(function() {
        if (this.value === this.defaultValue) {
            this.value = '';
        }
    });
    
    $('.hide-input input, .search input, .box-search input').focus(function() {
        if (this.value === this.defaultValue) {
            this.value = '';
        }
    });

    $('.hide-input input, .search input, .box-search input').blur(function() {
        if (this.value === '') {
...
/* celula */
function ativaSelect(id)
{
    $("#"+id).sbCustomSelect().each(
        function() {
            $(".sb-dropdown").wrap("<div class='sb-overlay'></div>");
    });
}